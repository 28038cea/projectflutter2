class Penjualan {
  ...
  //(Data dari sql yang tersimpan akan berbentuk Map)   //setelah itu, akan disimpan kembali ke dalam variable.
  ...
  //setter ini akan dipakai untuk mengembalikan nilai yang dimasukkan dari constructor   //per variable saja
