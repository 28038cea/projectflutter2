...
import 'package:vocer/models/penjualan.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: penjualan == null
            ? Text("Transaksi Baru", style: TextStyle(color: Colors.white))
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        if (penjualan == null) {
                          ...
                          //menggunakan data sebelumnya atau sesuai variabel controller                           penjualan.name=nameController.text;
